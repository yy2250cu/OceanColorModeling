...
def spatial_plots_distance(dfDistance):
    ...
    dfDistance.plot(kind='scatter', x='lon', y='lat', c='dist', cmap='RdBu_r',  edgecolor='none',
                    ax=axis, title='distance to the nearest coast', fontsize=12)
    #plt.savefig('distance_to_coast_points.png')  # for plot, to be removed!!
    plt.show()
    plt.close()
